  ...
  <div style="padding: 15px 20px;height: 100%">
    <div style="display: flex;flex-direction: column;height: 100%">
      <div>
        ...
        <div>子账户同样用于管理服务器，但是可以自由分配指定的服务器，子账户只能访问被分配到的服务器。</div>
      ...
      <div>
        <el-form label-position="top" :rules="rules" :model="form"
          ...
          <el-form-item label="用户名" prop="username">
            <el-input type="text" v-model="form.username" :prefix-icon="User"
                      placeholder="子账户用户名" maxlength="16" />
          </el-form-item>
          <el-form-item label="电子邮件" prop="email">
            <el-input type="email" v-model="form.email" :prefix-icon="Message"
                      placeholder="子账户电子邮件" maxlength="16" />
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <el-input type="password" v-model="form.password" :prefix-icon="Lock"
                      placeholder="子账户密码" maxlength="16" />
          </el-form-item>
        </el-form>
        <el-divider style="margin: 10px 0" />
